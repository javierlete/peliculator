...
public class ErrorServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String errorExceptionType = request.getAttribute(RequestDispatcher.ERROR_EXCEPTION_TYPE).toString();
		...
		//log.severe(((Exception) request.getAttribute(RequestDispatcher.ERROR_EXCEPTION)).getStackTrace().toString());
